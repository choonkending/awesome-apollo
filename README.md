...
1. [Apollo Documentation](http://dev.apollodata.com/)
   - [Set up](http://dev.apollodata.com/react/initialization.html)
   - [Connecting data](http://dev.apollodata.com/react/higher-order-components.html)
   - [Integrating with Redux](http://dev.apollodata.com/react/redux.html)
...
3. [Query Batching in Apollo](https://dev-blog.apollodata.com/query-batching-in-apollo-63acfd859862#.58jzb1n5a)
